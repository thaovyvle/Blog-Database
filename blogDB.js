...
// GET /post/[postId]/ : Retrieves a single post object based on postId 
...
// POST /post : Accepts a JSON object as the body of the request containing 
...
// DELETE /post/[postId] : Removes the post from the database based on the 
// postId field.
...
// POST /post/[postId]/comment : Adds a comment to the end of the post and 
...
// GET /post/[postId]/comments : Returns all comments associated with 
// a given postId
...
// DELETE /post/[postId]/comment/[commentId] : Deletes the comment with the 
